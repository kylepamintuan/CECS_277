...
public class LinkedLists 
{
	public static void main(String[] args) 
	{
		try
		{
			...
			LinkedList<LinkedList<String>> teams = new LinkedList<LinkedList<String>>();
			...
			for(int i = 0; i < userInput; i++)
			{
				...
				LinkedList abc = (LinkedList)items.clone();
			...
			{   	
				...
				LinkedList itemElement = (LinkedList)cursor2.next();
			...
			{
				LinkedList itemElement = (LinkedList)cursor2.previous();
